...
CITY_CODES = {"北京": "100010000", "上海": "100020000", "深圳": "100030000",
              "杭州": "100040000", "广州": "100050000", "成都": "100060000",
              "武汉": "100070000", "南京": "100080000", "西安": "100090000"}

POSITIONS = ["AI工程师", "大模型", "数据工程", "后端开发", "DevOps",
             "产品经理", "技术总监"]


class BOSSCrawler:
    def __init__(self, headless: bool = True, profile_dir: str = "data/chrome_profile",
    ...
    async def fetch_jobs(self, position: str, city_code: str = "100010000",
        ...
        async with async_playwright() as pw:
            ...
            for page_num in range(1, max_pages + 1):
                ...
                try:
                    ...
                    for job in jobs:
                        job["salary_min_k"], job["salary_max_k"] = self._parse_salary(job.pop("salary_text", ""))
