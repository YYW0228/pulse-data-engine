...
class CheckpointManager:
    ...
    def save(self, run_id: str, task_name: str, stage: str,
             offset: int, total: int, processed: int):
    ...
    def complete(self, run_id: str, task_name: str, stage: str):
        ckpt_id = f"{run_id}_{task_name}_{stage}"
        self.con.execute(
            "UPDATE processing_checkpoints SET status='completed' WHERE checkpoint_id=?",
            [ckpt_id]
        )
